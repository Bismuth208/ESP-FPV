...
// Also by default it will be set to lowest value, but new one will be sent from the Receiver.
#define DEFAULT_WIFI_TX_POWER (40)
...
#error "WiFi Tx power is too low, see WIFI_MIN_TX_POWER_PERCENTAGE"
#endif

#if(DEFAULT_WIFI_TX_POWER > WIFI_MAX_TX_POWER_PERCENTAGE)
#error "WiFi Tx power is too high, see WIFI_MAX_TX_POWER_PERCENTAGE"
#endif
...
// TODO: BD-0001 fix for limited range due to North America.
#define AIR_MAX_CHANNELS_TO_SCAN (14)

// How much AP on channel to collect info from
#define AIR_SCANNER_MAX_AP_NUM (32)

// Yeah, this is not over9000...
// 90 is lowest signal value in dBm
